...
comprobar si las variables se dstribuyen normalmente. Debido a que se presentaron pocos datos que si cumplen
...
![Relación de edad al diagnóstico y mutaciones más frecuentes](../res/Edad_MUTID.pdf){width=60%}
...
de mutaciones. Cada punto es una comparación y los colores son
...
El primer histograma muestra que la distribución de la edad
...
![Histograma de edades al diagnóstico](../res/Histograma_edad_diag.pdf){width=60%}

El segundo histograma, aunque basado en un subconjunto más
...
![Histograma de edades](../res/Histograma_edad.pdf){width=60%}
...
indicando que la relación es muy débil. Esto coincide con el valor de $\rho$
