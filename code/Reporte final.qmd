...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{`r here("res", "Correlacion_edad_diag.pdf")`}
\end{minipage}
\end{figure}
```
...
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{`r here("res", "Distribución_casos_CR_hombres.pdf")`}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth]{`r here("res", "Distribución_casos_CR_mujeres.pdf")`}
\end{minipage}
\end{figure}
```
