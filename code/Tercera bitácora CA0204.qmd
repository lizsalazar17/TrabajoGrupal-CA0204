...
En este gráfico se presentan diferencias de rangos promedio entre pares de mutacione. Cada punto es una comparación y los colores son determindados de acuerdos a si el valor p es menor a 0,05 (rojos) y o sino (grises), es decir, si se presenta una diferencia estadística significativa. 
